module Converter = {
  ...
  module IngredientBaseSpread = NormalizrSetup.DomainTypeConverter(IngredientBaseSpread, IngredientBaseSpread.Container, NormalizrRecordType.Wrapper.IngredientBaseSpread);
